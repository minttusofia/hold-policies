...
class SAC(RLAlgorithm):
    ...
    def __init__(
        ...
        # observation_shape = (np.prod(image_shape),)
...
#        print("training ops:", self._training_ops)
    ...
    def _augment_image(self, flat_image):
        ...
        if not self._should_augment:
            return flat_image
        image = tf.reshape(flat_image, (-1,) + self._image_shape)
        ...
        if self._should_augment:
            ...
            image = tf.image.random_crop(image, (256,) + self._image_shape)
