...
class SimpleSampler(BaseSampler):
    def __init__(self, env_reward_weight=1.0, env_reward_offset=0.0, **kwargs):
        ...
        self._env_reward_weight = env_reward_weight
        self._env_reward_offset = env_reward_offset
    ...
    def sample(self):
        ...
        reward = self._env_reward_weight * reward + self._env_reward_offset
        self._path_length += 1
