...
from hold_policies.policies.utils import get_policy_from_variant
...
def simulate_policy(args):
    ...
    evaluation_environment = get_goal_example_environment_from_variant(variant)
    ...
    with gzip.open(
        os.path.join(checkpoint_path,
                     f'eval_trajs_n{args.num_rollouts}.pkl.gz'),
        'wb') as f:
        pickle.dump(paths, f)
    return paths
