...
from hold_policies.environments.utils import get_environment_from_params
...
class ExperimentRunner(tune.Trainable):
    def _setup(self, variant):
        ...
        # Make sure the algorithm can access the same log directory.
        seed = variant['run_params']['seed']
        ray_logdir = glob.glob(
            os.path.join(variant['local_dir'],
                         variant['experiment_id'],
                         f'*-seed={seed}_*'))[0]
        variant['algorithm_params']['kwargs']['logdir'] = ray_logdir
